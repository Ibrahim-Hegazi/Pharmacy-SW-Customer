            ...
            Expanded(
              child: ListView(
                children: [
                  ...
                  ShoppingItem(imagePath: 'images/majestic.jpg'),
                  SizedBox(height: 20.0),
                  ShoppingSummary(),
                ],
              ),
...
class RemoveItem extends StatefulWidget {
  ...
  static _RemoveItemState? of(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType<_RemoveItemScope>()?.state;
  }
...
class _RemoveItemScope extends InheritedWidget {
  ...
  _RemoveItemScope({Key? key, required this.state, required Widget child}) : super(key: key, child: child);
